    ...
    <div className="platform-container">
      ...
      <div className="platform-conclusion">
        <p>
          ...
          <span className="text-emphasis">robust, transparent, and efficient</span> way for African farming{" "}
          <span className="text-emphasis">organizations</span> to prepare for and achieve{" "}
        ...
        <div className="cta-container">
          {/* Changed text to Contact Us but kept original styling */}
          <a href="/contact" className="platform-cta">
            Contact Us
          </a>
          {/* Updated to link to the specified URL */}
          <a
            href="https://ecopiavaluechain.com"
            target="_blank"
            rel="noopener noreferrer"
            className="platform-cta secondary"
          >
            Learn More
          </a>
        </div>
